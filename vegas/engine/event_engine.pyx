"""Event-driven backtesting engine module for Vegas.

This module provides a high-performance event-driven backtesting implementation
using Cython for optimal execution speed.
"""
...
cdef class EventDrivenEngine:
    """Cython-optimized event-driven backtesting engine."""
    ...
    cdef public:
        ...
        object data_layer
        object logger
        dict events_by_timestamp
        bint debug
    
    def __init__(self, strategy, portfolio, data_layer, logger, debug=False):
    ...
    def run_event_driven_backtest(self, events_df):
        ...
        """
        cdef int i, n_events, event_type
        cdef object timestamp, data_slice, signal_df
